...
GUIDE = [
    ...
    ('↩️ ביטול', '/?s=tidy', 'אחרי ניקוי, סימון „שולם” או מחיקה — כפתור „↩️ ביטול” לכמה דקות.'),
    ('🌱 מצב פשוט', '/?s=me#simple', 'רק „היום שלי”, תיבות, חיפוש ומדריך. השאר זמין ב-Ctrl+K.'),
    ('📨 להזכיר בעדינות', '/today', 'ליד מי שלא ענה לך: תזכורת מנומסת באותה שיחה, בלחיצה.'),
    ('🏖️ מי בחופש', '/today', 'קיבלת מענה אוטומטי „בחופש עד 3/10”? זה מופיע ליד השם.'),
    ('⭐ מאנשים חשובים', '/?s=me#quiet', 'מיילים מה-VIP שלך בכרטיס משלהם ב„היום שלי”.'),
    ('🔥 רצף', '/today', 'כמה ימים ברצף אף אחד לא חיכה לתשובה ממך.'),
    ('🔖 חיפושים שמורים', '/search', 'חיפוש שחוזר על עצמו — בלחיצה אחת.'),
    ('📝 הערות ללקוח', '/clients', 'בכרטיס הלקוח: מחירים שסוכמו, איש קשר, העדפות.'),
